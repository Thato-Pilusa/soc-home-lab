...
Full network design and rationale: architecture/network-diagram.md IP allocation and port reference: architecture/ip-addresses.md wazuh-mgr build, networking, and install troubleshooting: setup/wazuh-mgr-build.md
...
All lab traffic is isolated to a VirtualBox host-only network (192.168.56.0/24) with no route to the physical LAN — see architecture/network-diagram.md for why.
